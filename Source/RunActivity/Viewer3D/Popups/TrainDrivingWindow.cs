...
namespace Orts.Viewer3D.Popups
{
    public class TrainDrivingWindow : Window
    {
        ...
        private void UpdateColsWidth(ListLabel label, bool normalmode)
        {
            ...
            else
            {
                if (this.Visible)
                {
                    ...
                    var AutopilotOn = (Owner.Viewer.PlayerLocomotive.Train.TrainType == Train.TRAINTYPE.AI_PLAYERHOSTING || Owner.Viewer.PlayerLocomotive.Train.Autopilot) ? true : false; // joe179star autopilot
        ...
        public IEnumerable<ListLabel> TrainDrivingWindowList(Viewer viewer, bool normalTextMode)
        {
            ...
            bool autopilot = locomotive.Train.TrainType == Train.TRAINTYPE.AI_PLAYERHOSTING || locomotive.Train.Autopilot; // joe179star autopilot
            AddLabel(new ListLabel
            {
