...
namespace Orts.Simulation.RollingStocks.SubSystems.PowerSupplies
{
    ...
    public class ScriptedCircuitBreaker : ITractionCutOffSubsystem
    {
        ...
        {
            if ((Locomotive.Train.TrainType == Train.TRAINTYPE.AI && !Locomotive.Train.Autopilot) || Locomotive.Train.TrainType == Train.TRAINTYPE.AI_AUTOGENERATE //joe179star autopilot
